...
export async function getFighterInfo(fighterId) {
  ...
  // fighterDetailsMap.set();

  // Object.keys(fighterInfo).forEach((key) => fighterDetailsMap.set(key, fighterInfo[key]));

  // console.log(fighterDetailsMap.set(Object.entries(fighterInfo)));
  // const fighterDetailsMap = new Map(Object.entries(fighterInfo));
  return fighterInfo;
}

// getFighterInfo(1).then(console.log);
